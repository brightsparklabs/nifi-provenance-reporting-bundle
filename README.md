...
| Elasticsearch Attribute Exclusion List           | The comma-separated list of attributes to exclude from the data sent to Elasticsearch. All other attributes will be included. <br/><sub>**NOTE**: This property is mutually exclusive with the Elasticsearch Inclusion List.</sub>                                |                         | `NIFI_PROVENANCE_REPORTING_ELASTICSEARCH_ATTRIBUTE_EXCLUSION_LIST`                                                                                                                                        |
| Elasticsearch Component Id Filter Inclusion List | The comma-separated list of component ids to include when filtering the events sent to Elasticsearch. All other events will be excluded. <br/><sub>**NOTE**: This property is mutually exclusive with the Elasticsearch Component Id Filter Exclusion List.</sub> |                         | `NIFI_PROVENANCE_REPORTING_ELASTICSEARCH_COMPONENT_ID_FILTER_INCLUSION_LIST`                                                                                                                              |
| Elasticsearch Component Id Filter Exclusion List | The comma-separated list of component ids to exclude when filtering the events sent to Elasticsearch. All other events will be included. <br/><sub>**NOTE**: This property is mutually exclusive with the Elasticsearch Component Id Filter Inclusion List.</sub> |                         | `NIFI_PROVENANCE_REPORTING_ELASTICSEARCH_COMPONENT_ID_FILTER_EXCLUSION_LIST`                                                                                                                              |
| Elasticsearch Event Type Filter Inclusion List   | The comma-separated list of event types to include when filtering the events sent to Elasticsearch. All other events will be excluded. <br/><sub>**NOTE**: This property is mutually exclusive with the Elasticsearch Event Type Filter Exclusion List.</sub>     |                         | `NIFI_PROVENANCE_REPORTING_ELASTICSEARCH_EVENT_TYPE_FILTER_INCLUSION_LIST`                                                                                                                                |
| Elasticsearch Event Type Filter Exclusion List   | The comma-separated list of event types to exclude when filtering the events sent to Elasticsearch. All other events will be included. <br/><sub>**NOTE**: This property is mutually exclusive with the Elasticsearch Event Type Filter Inclusion List.</sub>     |                         | `NIFI_PROVENANCE_REPORTING_ELASTICSEARCH_EVENT_TYPE_FILTER_EXCLUSION_LIST`                                                                                                                                |
